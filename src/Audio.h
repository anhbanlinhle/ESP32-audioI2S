...
extern __attribute__((weak)) void audio_playback_start(const char*); // Called when audio playback starts
...
private:
    ...
    bool            m_f_playbackStarted = false;    // Flag to track if playback start has been logged
};
